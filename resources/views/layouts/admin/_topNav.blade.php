    ...
    <div class="container">
        <div class="">
            ...
            <ul class="nav navbar-nav navbar-right pull-right">
                ...
                <li class="dropdown">
                    <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown" aria-expanded="true"><img src="{{ asset('assets/admin/images/avatar-1.jpg') }}" alt="user-img" class="img-circle"> </a>
